...
const FoyerDB = (() => {
  ...
  const DEFAULTS = {
    ...
    articles: [
      ...
      { id: 'saj-encyclopedies-brutes', service: 'saj', cat: 'exposition', catLabel: 'Exposition', date: '2026-02-05', title: "Les Nouvelles Encyclopédies Brutes — exposition d'art brut", excerpt: "Le SAJ présente sa première exposition d'art brut collectif en Seine-Saint-Denis, peut-être la première d'une biennale.", img: 'https://picsum.photos/seed/saj-encyclopedies/800/500', featured: true, published: true, readTime: 5, content: `<p>Le Service d'Accueil de Jour Les Trois Rivières présente « Les Nouvelles Encyclopédies Brutes », une exposition d'art brut collectif en Seine-Saint-Denis.</p><p>Parce que nous sommes toujours en lien avec nos camarades d'aventures brutes de plusieurs pays. Parce que, bien au-delà de la vision romantique de l'artiste maudit, nous sommes toujours en lien avec l'ensemble de la société.</p><p>Parce que la société se construit à partir de l'activité de tout le monde. Elle n'est pas une identité abstraite où il faut nous inclure. Elle est un produit de nous-tous autant que nous sommes un produit d'elle.</p><p>Pour un art brut jamais isolé ni abstrait, mais pour un art brut vraiment direct et constructif.</p>` },
      { id: 'saj-forum-associations-2024', service: 'saj', cat: 'evenement', catLabel: 'Événement', date: '2024-09-07', title: "Le SAJ au forum des associations", excerpt: "On a présenté notre travail, on a connu des gens, c'était la fête, on a vu des concerts, pique-nique, danser.", img: 'https://picsum.photos/seed/saj-forum-2024/800/500', featured: false, published: true, readTime: 2, content: `<p>Samedi 7 septembre 2024, le SAJ était présent au forum des associations. Nous avons présenté notre travail, rencontré du monde, profité des concerts et partagé un pique-nique dansant.</p>` },
      { id: 'saj-sonic-protest', service: 'saj', cat: 'festival', catLabel: 'Festival', date: '2024-03-25', title: "Participation au festival Sonic Protest à Paris", excerpt: "Le SAJ a participé au festival Sonic Protest : on a fait à manger, le service et le satellite.", img: 'https://picsum.photos/seed/saj-sonic/800/500', featured: false, published: true, readTime: 2, content: `<p>Le SAJ a participé au festival Sonic Protest à Paris. Nous avons préparé le repas, assuré le service et animé le satellite. Une belle expérience de participation à un événement culturel parisien.</p>` },
      { id: 'saj-expo-gem-couronnes', service: 'saj', cat: 'exposition', catLabel: 'Exposition', date: '2024-03-08', title: "Exposition au GEM de Couronnes (Paris 20e)", excerpt: "Le SAJ expose ses créations au GEM de Couronnes dans le 20e arrondissement de Paris.", img: 'https://picsum.photos/seed/saj-gem-couronnes/800/500', featured: false, published: true, readTime: 1, content: `<p>En mars 2024, le SAJ a présenté une exposition de ses œuvres au GEM de Couronnes, Paris 20e. Une belle occasion de faire découvrir le travail créatif du service au-delà de Stains.</p>` },
      { id: 'saj-kiosque-autisme', service: 'saj', cat: 'evenement', catLabel: 'Événement', date: '2023-06-28', title: "Le Kiosque du SAJ à la Maison de l'Autisme", excerpt: "Le Kiosque du SAJ a participé à l'événement à la Maison de l'Autisme dans le cadre du colloque ALTER.", img: 'https://picsum.photos/seed/saj-autisme/800/500', featured: false, published: true, readTime: 2, content: `<p>Le Kiosque du SAJ a participé à un événement à la Maison de l'Autisme dans le cadre du colloque ALTER. Une reconnaissance du travail d'expression et de création du SAJ auprès d'un public spécialisé.</p>` },
      { id: 'saj-fleche-dor-spectacle', service: 'saj', cat: 'spectacle', catLabel: 'Spectacle', date: '2023-06-25', title: "Spectacle « La grande salade… et + » à La Flèche d'Or", excerpt: "Un spectacle créé du début à la fin par les personnes accueillies : chansons, costumes, masques, danse et exposition.", img: 'https://picsum.photos/seed/saj-fleche-dor/800/500', featured: true, published: true, readTime: 5, content: `<p>Le SAJ vous a invité le dimanche 25 juin à La Flèche d'Or pour un spectacle unique : « La grande salade… et + ».</p><p>Ce spectacle a été créé du début à la fin par nous-mêmes : chansons composées et enregistrées, costumes et masques confectionnés avec différents matériaux, danse de la vache, scène culte de Louis de Funès corrigée, projections, dialogues de la vie quotidienne… Rien de très conventionnel ni narratif, mais très visuel et auditif.</p><p>Une exposition de gravures et de dessins accompagnait le spectacle, avec un kiosque pour découvrir nos publications. Et un repas avec les spécialités faites par l'équipe cuisine.</p>` },
      { id: 'saj-moulin-parole-15', service: 'saj', cat: 'journal', catLabel: 'Journal', date: '2023-03-17', title: "Moulin à Parole n°15 — « Il fait beau, pour l'instant… »", excerpt: "Le 15e numéro du journal du SAJ est sorti, toujours aussi créatif et spontané.", img: 'https://picsum.photos/seed/saj-moulin15/800/500', featured: false, published: true, readTime: 2, content: `<p>Le Moulin à Parole 15 est paru en février 2023. « Il fait beau, pour l'instant… » — un numéro qui reflète la vie et les préoccupations du SAJ.</p><p>Consultez le journal sur Calaméo : <a href="https://www.calameo.com/books/006952296f0d0aed8dd12">Moulin à Parole 15</a></p>` },
